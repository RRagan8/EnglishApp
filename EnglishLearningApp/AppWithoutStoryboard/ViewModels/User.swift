...
class User{
    ...
    let interests_tags: String
    let time_intervals: String
    let telegram_notifications: Int
    let phone_notifications: Int
    let time_inactive: Int
    
    init(id: Int, nickname: String, motivation_tag: String, motivation_specification: String, interests_tags: String, time_intervals: String, telegram_notifications: Int, phone_notifications: Int, time_inactive: Int) {
        
        self.id = id
        self.nickname = nickname
        self.motivation_tag = motivation_tag
        self.motivation_specification = motivation_specification
        self.interests_tags = interests_tags
